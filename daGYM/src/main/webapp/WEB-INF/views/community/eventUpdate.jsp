...
<body>
	...
	<div class="container">
		...
		<div class="container pb-5 mb-5" id="content-main">
			...
			<h3>게시글 수정</h3>
			<hr>
			<form action="${boardType }" method="post" role="form" enctype="multipart/form-data" onsubmit="return validate();">
				...
				<div class="form-inline mb-2">
					...
					<input class="date mr-2" name="startDate" type="date"  value=${board.startDate }><h5>시작일</h5>
					<input class="date mr-2 ml-5" name="endDate" type="date" value="${board.endDate }"><h5>종료일</h5>
				</div>  
	...
	<script>
		...
		$(".deleteImg").on("click", function(event) {
			...
			event.stopPropagation(); // 삭제버튼 -> 이미지 클릭 -> file태그 클릭 == 이벤트버블링
									// 이벤트 버블링을 멈춤(삭제)
			...
			console.log(deleteImages)
	      	...
	      	// input type="file"태그의 value값은 readonly(읽기 전용)이므로
