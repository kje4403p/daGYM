...
public class Page {
    ...
    public Page(int currentPage, int listCount, int boardType, String category) {
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.boardType = boardType;
	...
	public Page(int currentPage, int listCount, int limit, int pagingBarSize, int boardType) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
