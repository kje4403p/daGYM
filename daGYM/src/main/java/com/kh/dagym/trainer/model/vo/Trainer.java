...
public class Trainer {
	...
	public Trainer(int trainerNo, String memberId, String memberPwd, String memberName, String memberPhone,
			...
			int trainerPrice, String trainerSNS, String trainerComment, String trainerAward, int reviewGrade,
			int trainerGrade) {
		super();
	...
	public int getTrainerGrade() {
		return trainerGrade;
	}
	public void setTrainerGrade(int trainerGrade) {
		this.trainerGrade = trainerGrade;
	}
	@Override
	public String toString() {
		return "Trainer [trainerNo=" + trainerNo + ", memberId=" + memberId + ", memberPwd=" + memberPwd
				...
				+ ", reviewGrade=" + reviewGrade + ", trainerGrade=" + trainerGrade + "]";
	}
